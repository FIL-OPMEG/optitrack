...
if istable(opti_data)
    ...
    switch angle_type
        case 'quaternion'
            ...
            subplot(3,1,1);
            plot(opti_data.Time,opti_data.X_Position,'r','LineWidth',2);
            set(gca,'FontSize',12);
            ylabel('Distance','FontSize',16);
            title('Rigid Body Position: X','FontSize',16);
            subplot(3,1,2);
            plot(opti_data.Time,opti_data.Y_Position,'g','LineWidth',2);
            set(gca,'FontSize',12);
            ylabel('Distance','FontSize',16);
            title('Rigid Body Position: Y','FontSize',16);
            subplot(3,1,3);
            plot(opti_data.Time,opti_data.Z_Position,'b','LineWidth',2);
            set(gca,'FontSize',12);
            ylabel('Distance','FontSize',16);
    ...
    % Assume the old function was used
